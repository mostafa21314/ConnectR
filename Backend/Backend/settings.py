...
SECRET_KEY = 'django-insecure-7w$@_%(c$$3^)5e-wnbu-w4d-^+vtm=u@^vs5*^kh26vhrl3ym'
...
ALLOWED_HOSTS = [
    ...
    '127.0.0.1',
    'connectr-backend-1',
    'connectr-backend-1:8000'  # You might need this one too
]
...
RESUME_PARSER_API_KEY = os.environ.get('VITE_APP_RESUME_PARSER_API_KEY')
